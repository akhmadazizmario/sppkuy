...
<head>
  ...
  <link rel="icon" type="image/png" href="<?php echo media_url('img/tutwuri.png') ?>">
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="<?php site_url('manage') ?>" class="logo">
        ...
        <?php } else { ?>
          <span class="logo-mini"><img src="<?php echo media_url('img/tutwuri.png') ?>" style="height: 40px; margin-top: 5px; margin-left:5px;" class="pull-left"></span>
        <?php } ?>
        <?php if (!empty(logo())) { ?>
        ...
        <?php } else { ?>
          <span class="logo-lg pull-left"><img src="<?php echo media_url('img/tutwuri.png') ?>" style="height: 40px; margin-top: 5px;" class="pull-left"><b>&nbsp;<?php echo $this->config->item('app_name') ?></b></span>
        <?php } ?>
      </a>
